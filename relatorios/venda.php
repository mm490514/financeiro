...
<table class="printer-ticket">
	...
	<tr>
		<th class="ttu margem-superior" colspan="3">
			Comprovante de Venda <?php if($cp11 == 'Cancelada'){ echo ' Cancelada';} ?>
...
?>
	...
	<td><center>R$ <?php echo $cp58 ?></center></td>	
	<td><center><?php echo $cp56 ?></center></td>	
	<td><center><?php echo $cp61 ?></center></td>	
	</tr>
