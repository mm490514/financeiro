...
echo '<select class="form-select form-select-sm" aria-label="Default select example" name="sub-cat-plano" id="sub-cat-plano">';
...
for($i=0; $i < @count($res); $i++){
	...
	echo '<option '.$selec.' value="">Todas</option>';
