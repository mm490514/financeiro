...
<div class="modal fade" id="modalContas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><span id="tituloModal">Contas do Cliente  <span id="nome-contas"></span></span></h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
				...
				<div class="modal-body">
					...
					<small><div id="mensagem-contas" align="center"></div></small>

					<input type="hidden" class="form-control" name="id-contas"  id="id-contas">
...
<div class="modal fade" id="modalBaixar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="form-baixar-contas" method="post">
				<div class="modal-body">
...
$("#form-baixar-contas").submit(function () {
    var pagin = 'contas_receber';
    var id = $('#id-contas').val();
    event.preventDefault();
    var formData = new FormData(this);
    
    $.ajax({
        url: pagin + "/baixar.php",
        type: 'POST',
        data: formData,
