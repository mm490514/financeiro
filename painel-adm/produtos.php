							...
							<div class="row">
								...
								<div class="col-md-4 col-sm-12">
									<div class="mb-3">
										...
										<select class="form-select sel2" aria-label="Default select example" name="<?php echo $campo8 ?>" id="<?php echo $campo8 ?>" style="width:100%">
											<?php 
								...
								<div class="col-md-4 col-sm-12">
									<div class="mb-3">
										<label for="exampleFormControlInput1" class="form-label">Nível Estoque</label>
										<input type="text" class="form-control" name="nivel_estoque" id="nivel_estoque" placeholder="Nível Mínimo">
									</div>
								</div>
