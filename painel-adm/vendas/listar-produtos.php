...
echo <<<HTML
<table id="exampleProd" class="table table-striped table-light table-hover my-4">
<thead>
<tr>
<th style="">Código</th>
...
$query = $pdo->query("SELECT * from $pagina where ativo = 'Sim' and estoque > 0 order by id desc ");
